...
require_relative "lib/alchemy_ruby/version"
...
Gem::Specification.new do |spec|
  ...
  spec.summary = "Read and write Alchemy files in Ruby."
  spec.homepage = "https://github.com/afstanton/alchemy_ruby"
  spec.license = "MIT"
  ...
  if spec.respond_to?(:metadata)
    ...
    spec.metadata["source_code_uri"] =  "https://github.com/afstanton/alchemy_ruby"
  else
